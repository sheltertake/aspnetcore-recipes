...
namespace FooApiE2eTests.Proxies.FooApi
{
    ...
    public partial class FooApiClient 
    {
        private string _baseUrl = "";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public FooApiClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<System.Collections.Generic.ICollection<WeatherForecast>>> WeatherForecastAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
                ...
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            ...
                            return new SwaggerResponse<System.Collections.Generic.ICollection<WeatherForecast>>(status_, headers_, objectResponse_.Object);
                        }
                        else
                        {
